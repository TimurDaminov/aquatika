...
function createHeroCard(card) {
  ...
  const cardLink = createElement('a', card.btnText, ['hero__card-btn'], {'href': card.btnLink})
...
function createCard(card) {
  ...
  const cardLink = createElement('a', card.link, ['card__btn'], {'href': card.linkHref})
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // HeroCards
  renderCard(hotSales, 'sales-cards')
  renderCard(blogCards, 'blog-cards')
